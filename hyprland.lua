...
hl.on("hyprland.start", function () 
    hl.exec_cmd("caelestia-shell") -- Caelestia Shell
end)
...
hl.config({
    ...
    animations = {
        enabled = true, -- Animations_toggle
    },
})
...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 18,   spring = "easy",         style = "popin 87%" })
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 14,   bezier = "linear",       style = "popin 87%" })
hl.animation({ leaf = "fadeIn",        enabled = true,  speed = 14,   bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut",       enabled = true,  speed = 14,   bezier = "almostLinear" })
hl.animation({ leaf = "fade",          enabled = true,  speed = 14,   bezier = "quick" })
...
hl.animation({ leaf = "layersOut",     enabled = true,  speed = 14,   bezier = "linear",       style = "fade" })
hl.animation({ leaf = "fadeLayersIn",  enabled = true,  speed = 14,   bezier = "almostLinear" })
hl.animation({ leaf = "fadeLayersOut", enabled = true,  speed = 14,   bezier = "almostLinear" })
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 16,   bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 16,   bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 16,   bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "zoomFactor",    enabled = true,  speed = 18,   bezier = "quick" })
